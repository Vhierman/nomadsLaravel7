                ...
                <div class="row">
                        ...
                        <div class="card card-details">
                            ...
                            <div class="member mt-3">
                                ...
                                <form class="form-inline" method="post" action="{{route('checkout-create',$item->id)}}">
                                    ...
                                    <input type="text" name="username" id="username"  class="form-control mb-2 mr-sm-2" placeholder="Masukan Username" required>

                                    <label for="nationality" class="sr-only">Nationality</label>
                                    <input type="text" name="nationality" id="nationality" style="width:60px" 
                                    class="form-control mb-2 mr-sm-2" placeholder="Nationality" required>
                                    ...
                                    <div class="input-group mb-2 mr-sm-2">
                                        ...
                                        class="form-control datepicker" placeholder="doePassport">
                                    </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="join-container">
                            <a href="{{route('checkout-success',$item->id)}}" class="btn btn-block btn-join-now mt-3 py-2">I Have Maid Payment</a>
                        </div>
